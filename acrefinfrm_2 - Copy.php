									...
									<div class="step" id="Step1">
										...
										<div class="form-content">
											...
											<div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      	<select id="f2_edudetail" name="f2_edudetail" class="input-xxlarge" data-rule-required="true" onchange="calTotal()">
                                            ...
                                            <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      	<select id="f2_proficiency" data-rule-required="true" name="f2_proficiency" class="input-xxlarge" onchange="calTotal()">
                                                      		<option value="" disabled selected> Select here</option>
                                            ...
                                            <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      	<select id="f2_participation" data-rule-required="true" name="f2_participation" class="input-xxlarge">
                                                      		<option value="" disabled selected> Select here</option>
                                        	...
                                        	<div id="program_detail" style="display: none; background-color: rgba(0,0,0,0.02); padding: 10px; box-shadow: 1px 1px 2px gray; margin: 20px;">
	                                        	...
	                                        	<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="Program name" id="f2_nameprog" name="f2_nameprog" class="input-xxlarge v_name" data-rule-required="true" data-rule-minlength="4" data-rule-maxlength="100">
													</div>
												</div>
	                                        	...
	                                        	<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="yyyy-mm-dd" id="f2_dateprog" name="f2_dateprog" class="datepicker" data-rule-required="true">
													</div>
												</div>
		                                        <!-- Date of the program -->
		                                        ...
		                                        <div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="00" id="f2_durprog" name="f2_durprog" class="input-xxlarge v_number" data-rule-required="true" data-rule-number="true"  data-rule-maxlength="3">
													</div>
												</div>
	                                        	...
	                                        	<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="Full name" id="f2_condprog" name="f2_condprog" class="input-xxlarge v_name" data-rule-required="true" data-rule-minlength="4" data-rule-maxlength="100">
													</div>
												</div>
	                                        	...
	                                        	<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="Name" id="f2_cropprog" name="f2_cropprog" class="input-xxlarge v_name" data-rule-required="true" data-rule-minlength="6" data-rule-maxlength="100">
													</div>
												</div>
