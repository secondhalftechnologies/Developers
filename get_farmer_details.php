<?php
    ...
    if($res_spouse_details)
    {
        ...
        if($num_spouse_details != 0)
        {
            ...
            //$data['f3_english_profeciency']     = $row_spouse_details['f3_english_profeciency'];
                            ...
                            <div class="box box-color box-bordered">
                                ...
                                <div class="box-content nopadding tab-content-inline">
	                            	<ul class="tabs tabs-inline tabs-top">
                                        <li id="main_li_kyc" class='active'>
                                                ...
                                                <div class="box-content nopadding">
                                                    <div class="tas-container">
                                                        <ul class="tabs tabs-inline tabs-left">
                                                            ...
                                                            {
                                                                ?>
                                                                <li class='active' id="li_spouse_details">
                                                            ...
                                                            ?>
                                                            <li id="li_appli_knowledge" <?php if($married_status == 'no'){ ?> class="active" <?php }  ?>>
                                                    ...
                                                    <div class="tab-content padding tab-content-inline">
														...
														if($married_status == 'yes')
                                                        {
                                                            ...
                                                            <div class="tab-pane active" id="div_spouse_details">
                                                                <form enctype="multipart/form-data" method="POST" class='form-horizontal form-bordered form-validate' id="frm_knowledge_detail">
                                                                    ...
                                                                    <input type="hidden" id="f3_points" name="f3_points" value="<?php echo $data['f3_points']; ?>">
                                                                    ...
                                                                    <div class="form-content">
                                                                        ...
                                                                        <div id="spouse_detail" style="padding:5px;border:1px solid #d6d6d6;margin:5px;">
                                                                            <div class="control-group">
                                                                                ...
                                                                                <div class="controls">
                                                                                    <input type="text" value="<?php if((isset($data['f3_spouse_fname'])) && $data['f3_spouse_fname'] != '') { echo $data['f3_spouse_fname']; } ?>" id="f3_spouse_fname" name="f3_spouse_fname" class="input-xlarge v_name" data-rule-minlength="3" data-rule-maxlength="50" data-rule-required="true" placeholder="Spouse Name">
                                                                                </div>
                                                                            </div>	<!-- Spouse Name -->
                            												
                                                                            <div class="control-group">
											                                	<label for="tasktitel" class="control-label">
											                                    	Spouse Date Of Birth <span style="color:#F00">*</span>
											                                    </label>
											                                    <div class="controls">
											                                    	<input type="text" id="f3_spouse_dob" name="f3_spouse_dob" value="<?php if((isset($data['f3_spouse_dob'])) && $data['f3_spouse_dob'] != '') { echo $data['f3_spouse_dob']; } ?>" placeholder="Date Of Birth" class="datepicker input-large" data-rule-required="true" />
											                                    </div>
											                                </div>	<!-- DOB -->
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <div class="controls">
                                                                                    <input readonly type="text" value="<?php if((isset($data['f3_spouse_age'])) && $data['f3_spouse_age'] != '') { echo $data['f3_spouse_age']; } ?>" id="f3_spouse_age" name="f3_spouse_age" class="v_number input-xlarge" data-rule-number="true" data-rule-maxlength="3" maxlength="3" onKeyPress="return numsonly(event);" data-rule-required="true" placeholder="Age">
                                                                                </div>
                                                                            </div>	<!--age-->
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <div class="controls">
                                                                                    <input type="text" value="<?php if((isset($data['f3_spouse_mobno'])) && $data['f3_spouse_mobno'] != '') { echo $data['f3_spouse_mobno']; } ?>" placeholder="Mobile no." name="f3_spouse_mobno" id="f3_spouse_mobno" class="input-xlarge v_number" data-rule-number="true" maxlength="10" onKeyPress="return numsonly(event);" data-rule-minlength="10"  data-rule-maxlength="10" data-rule-required="true" >
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <div class="controls">
                                                                                    <input type="text" value="<?php if((isset($data['f3_spouse_adhno'])) && $data['f3_spouse_adhno'] != '') { echo $data['f3_spouse_adhno']; } ?>" placeholder="Aadhaar no." name="f3_spouse_adhno" id="f3_spouse_adhno" class="input-xlarge v_number" data-rule-number="true" maxlength="12" onKeyPress="return numsonly(event);" data-rule-minlength="12"  data-rule-maxlength="12" data-rule-required="true">
                                                                                </div>
                                                                            </div>	<!--aadhar no-->
                            												
                                                                            <!-- <div class="control-group">
                                                                                <label for="text" class="control-label" style="margin-top:10px">English Language Profeciency <span style="color:#F00">*</span></label>
                                                                                <div class="controls">
                                                                                    <select id="f3_english_profeciency" name="f3_english_profeciency" class="select2-me input-xlarge" data-rule-required="true">
                                                                                        <option value="" disabled selected> Select here</option>
                                                                                        <option value="Understand" <?php //if((isset($data['f3_english_profeciency'])) && $data['f3_english_profeciency'] == 'Understand'){ ?> selected <?php //}  ?>> Understand</option>
                                                                                        <option value="Read" <?php //if((isset($data['f3_english_profeciency'])) && $data['f3_english_profeciency'] == 'Read'){ ?> selected <?php //}  ?>> Read</option>
                                                                                        <option value="Write" <?php //if((isset($data['f3_english_profeciency'])) && $data['f3_english_profeciency'] == 'Write'){ ?> selected <?php //}  ?>> Write</option>
                                                                                        <option value="Profecient" <?php //if((isset($data['f3_english_profeciency'])) && $data['f3_english_profeciency'] == 'Profecient'){ ?> selected <?php //}  ?>> Profecient</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div> -->
                                                                            ...
                                                                            <div class="control-group">
                                                                                <label for="tasktitel" class="control-label">
                                                                                    Is the Spouse also member of the same FPO?  <span style="color:#F00">*</span>
                                                                                </label>
                                                                                <div class="controls">
                                                                                    <select id="f3_is_fpo_member" name="f3_is_fpo_member" class="select2-me input-xlarge" data-rule-required="true">
                                                                                        <option value="" disabled selected> Select here</option>
                                                                                        <option value="yes" <?php if((isset($data['f3_is_fpo_member'])) && $data['f3_is_fpo_member'] == 'yes'){ ?> selected <?php }  ?>> Yes</option>
                                                                                        <option value="no" <?php if((isset($data['f3_is_fpo_member'])) && $data['f3_is_fpo_member'] == 'no'){ ?> selected <?php }  ?>> No</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="tab-pane <?php if($married_status == 'no'){ ?> active <?php }  ?>" id="div_appli_knowledge">
                                                           	<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_applicant_knowledge" name="frm_applicant_knowledge">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f2_points" name="f2_points" value="<?php echo $data['f2_points']; ?>">
                                                        ...
                                                        <div class="tab-pane" id="div_phone_details">
                                                        	...
                                                        	<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_applicant_phone" name="frm_applicant_phone">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f5_points" name="f5_points" value="<?php echo $data['f5_points']; ?>">
                                                                ...
                                                                <div class="form-content">
                                                                    ...
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <div id="div_serv_prov_display">
                                                                            <?php
                                                                            // Query For Getting the list of service Provider
                                                                            $sql_get_list_servpro	= " SELECT * FROM `tbl_servpro` WHERE `servpro_status`='1' AND servpro_name NOT IN (SELECT DISTINCT(serv_pro_name) FROM tbl_farmer_servpro WHERE fm_id='".$fm_id."') ";
                                                                            ...
                                                                            ?>
                                                                            <select multiple="multiple"  onChange="console.log($(this).children(':selected').length)" placeholder="Select Service Provider" id="f5_servpro" name="f5_servpro[]" class="select2-me input-xxlarge" >
                                                                               	<?php
																				if($num_get_list_servpro != 0)
	                                                                            {
	                                                                            	...
	                                                                            	{
	                                                                            		?>
	                                                                            		<option value="<?php echo $row_get_list_servpro['servpro_name']; ?>"><?php echo trim(ucwords($row_get_list_servpro['servpro_name'])); ?></option>
	                                                                                	<?php
	                                                                            	}
	                                                                            }
	                                                                            ?>
                                                                            </select>
                                                                            <input value="Add Here" class="btn-success" type="button" onclick="addServProv(<?php echo $fm_id; ?>);">
	                                                                            	...
	                                                                            	<thead>
	                                                                            		...
	                                                                            		<th style="text-align:center">
	                                                                            			<div style="text-align:center">
	                                                                            				<input type="button" value="Delete" onclick="multipleServProDelete(<?php echo $fm_id; ?>);" class="btn-danger"/>
	                                                                            			</div>
	                                                                            		</th>
	                                                                            	</thead>
	                                                                            	<tbody>
	                                                                            		...
	                                                                            		if($num_get_farmer_servpro != 0)
	                                                                            		{
	                                                                            			while($row_get_farmer_servpro = mysqli_fetch_array($res_get_farmer_servpro))
	                                                                            			{
	                                                                            				...
	                                                                            				<tr>
																									<td>
																										<?php echo ++$startOffset; ?>
																									</td>
																									<td>
																										<?php echo ucwords($row_get_farmer_servpro['serv_pro_name']); ?>
																									</td>
																									<td align="center">
																										<!-- <div class="controls" align="center"> -->
																											<input type="checkbox" value="<?php echo $row_get_farmer_servpro['id'] ?>" id="farmer_servpro_'.$row_get_farmer_servpro['id'].'" name="farmer_servpro_'.$row_get_farmer_servpro['id'].'" class="css-checkbox farmer_servpro">
																										<!-- </div> -->
																									</td>
																								</tr>
	                                                                            				<?php
                                                                    ...
                                                                    <div class="control-group">
                                                                        <label for="text" class="control-label" style="margin-top:10px">Is the Network Good?</label>
                                                                        <div class="controls">
                                                        ...
                                                        <div class="tab-pane" id="div_family_details">
                                                            ...
                                                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_family_details" name="frm_family_details">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f6_points" name="f6_points" value="<?php echo $data['f6_points']; ?>">
                                                        ...
                                                        <div class="tab-pane" id="div_appliances_motors">
                                                            <div class="span10" style="padding: 5px; border: 1px solid #d6d6d6; margin: 5px;">
                                                            	...
                                                            	<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_appliances_motors" name="frm_appliances_motors">
                                                                    ...
                                                                    <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                    <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                    <input type="hidden" id="f7_points" name="f7_points" value="<?php echo $data['f7_points'] ?>" >
                                        ...
                                        <div class="tab-pane" id="land">
                                            <div class="box box-bordered box-color lightgrey">
                                                <div class="box-content nopadding">
                                                    <div class="tas-container">
                                                        <ul class="tabs tabs-inline tabs-left">
                                                            <li id="li_farm_land_details" class='active'>
                                                    ...
                                                    <div class="tab-content padding tab-content-inline">
                                                        <div class="tab-pane active" id="div_farm_land_details">
                                                    		<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_farm_land_details" name="frm_farm_land_details">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" name="f9_points" value="<?php if(isset($pt_row['pt_frm9']) && $pt_row['pt_frm9'] != ''){ echo $pt_row['pt_frm9']; }else{ echo '0'; } ?>" id="f9_points">
                                                                            	...
                                                                            	<div id="land_detail" style=" padding: 10px; margin: 5px;">
                                                                                    ...
                                                                                    <div class="control-group">
                                                                                        ...
                                                                                        <div class="controls">
                                                                                        	...
                                                                                        	<div id="div_f9_source_of_water<?php echo $id; ?>">
                                                                                        		<?php
                                                                                        		// Query For getting the list of Water Source
																								$sql_get_f9_water_source_list	= " SELECT * FROM `tbl_water_source` WHERE `status`='1' AND water_source NOT IN (SELECT DISTINCT(water_source_name) FROM tbl_f9_farmer_water_source WHERE fm_id='".$fm_id."' AND count='".$id."') ";
																								...
																								if($res_get_f9_water_source_list)
																								{
																									...
																									?>
																									<select id="f9_source_of_water<?php echo $id; ?>" name="f9_source_of_water<?php echo $id; ?>[]" multiple="multiple"  onChange="console.log($(this).children(':selected').length)" placeholder="Select Water Source" class="select2-me input-xxlarge">
																							           	<?php
																										if($num_get_f9_water_source_list != 0)
																										{
																											...
																											{
																							            		?>
																							            		<option point="<?php echo $row_get_f9_water_source_list['points']; ?>" value="<?php echo $row_get_f9_water_source_list['water_source']; ?>">
																							            				<?php echo trim(ucwords($row_get_f9_water_source_list['water_source'])); ?>
																							           			</option>
																							                	<?php
																											}
																										}
																										...
																										{
																											?>
																							        		<option point="0" value="">No Match Found</option>
																							            	<?php
																										}
																							            ?>
																							        </select>
        																							<input value="Add Here" class="btn-success" type="button" onclick="addf9WaterSource(<?php echo $fm_id; ?>, <?php echo $id; ?>);">
																									<?php
																									// Query For getting the Service Provider list for that user
																							        ...
																							        <table class="table table-bordered dataTable">
																							        	<thead>
																							        		...
																							        		<th style="text-align:center">
																							        			<div style="text-align:center">
																							        				<input type="button" value="Delete" onclick="multipleWaterSourceDelete_f9(<?php echo $fm_id; ?>, <?php echo $id; ?>);" class="btn-danger"/>
																							        			</div>
																							        		</th>
																							        	</thead>
																							        	<tbody>
																							        		...
																							        		if($num_get_f9_farmer_water_source != 0)
																							        		{
																							        			while($row_get_f9_farmer_water_source = mysqli_fetch_array($res_get_f9_farmer_water_source))
																							        			{
																							        				...
																							        				<tr>
																														<td>
																															<?php echo ++$startOffset_f9; ?>
																														</td>
																														<td>
																															<?php echo ucwords($row_get_f9_farmer_water_source['water_source_name']); ?>
																														</td>
																														<td align="center">
																															<!-- <div class="controls" align="center"> -->
																																<input type="checkbox" value="<?php echo $row_get_f9_farmer_water_source['id'] ?>" id="f9_water_source_<?php echo $row_get_f9_farmer_water_source['id'] ?>" name="f9_water_source_<?php echo $row_get_f9_farmer_water_source['id'] ?>" class="css-checkbox f9_water_source">
																															<!-- </div> -->
																														</td>
																													</tr>
																							        				<?php
                                        ...
                                        <div class="tab-pane" id="crop">
                                            <div class="box box-bordered box-color lightgrey">
                                                <div class="box-content nopadding">
                                                    <div class="tas-container">
                                                        <ul class="tabs tabs-inline tabs-left">
                                                            <li id="li_crop_cultivation" class='active'>
                                                    ...
                                                    <div class="tab-content padding tab-content-inline">
                                                        <div class="tab-pane active" id="div_crop_cultivation">
                                                            ...
                                                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_crop_cultivation" name="frm_crop_cultivation">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" name="f10_points" id="f10_points" value="<?php if(isset($pt_row['pt_frm10']) && $pt_row['pt_frm10'] != ''){ echo $pt_row['pt_frm10']; }else{ echo '0'; } ?>">
                                                                        ...
                                                                        for($j = 0; $j < $no_of_crops; $j++)
																		{
																			...
																			<div id="crop<?php echo $id; ?>" style="padding:5px;border:1px solid #d6d6d6;margin:5px;">
                                                                                ...
                                                                                <div id="crop_detail" style=" padding: 10px; margin: 5px;">
                                                                                    ...
                                                                                    <div class="control-group">
                                                                                        <label for="text" class="control-label" style="margin-top:10px">Potential Crop Damage<span style="color:#F00">*</span></label>
                                                                                        <div class="controls">
                                                                                            <select id="f10_diseases<?php echo $id; ?>" name="f10_diseases<?php echo $id; ?>" class="select2-me input-xlarge" data-rule-required="true" onchange="calTotal_f10()">
                                                                                                <option value="" disabled selected> Select here</option>
                                                                                                <option point="1" value="Disease" <?php if((isset($crops_arr[$j]['f10_diseases'])) && $crops_arr[$j]['f10_diseases'] == 'Disease') { ?> selected <?php } ?>> Disease</option>
                                                                                                <option point="4" value="Pest" <?php if((isset($crops_arr[$j]['f10_diseases'])) && $crops_arr[$j]['f10_diseases'] == 'Pest') { ?> selected <?php } ?>> Pest</option>
                                                                                                <option point="5" value="Both" <?php if((isset($crops_arr[$j]['f10_diseases'])) && $crops_arr[$j]['f10_diseases'] == 'Both') { ?> selected <?php } ?>> Both</option>
                                                                                                ...
                                                                                                <option point="10" value="None" <?php if((isset($crops_arr[$j]['f10_diseases'])) && $crops_arr[$j]['f10_diseases'] == 'None') { ?> selected <?php } ?>> None</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>	<!--Potential crop Damage-->
                                                                                    ...
                                                                                    <div class="control-group span6">
	                                                                                    ...
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_consumption_fertilizer'])) && $crops_arr[$j]['f10_consumption_fertilizer'] != '') { echo $crops_arr[$j]['f10_consumption_fertilizer']; } ?>" id="f10_consumption_fertilizer<?php echo $id; ?>" name="f10_consumption_fertilizer<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Fertilizer in KGs"> KGs
	                                                                                    </div>
	                                                                                </div>	<!-- How much was the total consumption of Fertilizer in KGs -->

	                                                                                <div class="control-group span6">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Fertiliser?<span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_spend_money_fertiliser'])) && $crops_arr[$j]['f10_spend_money_fertiliser'] != '') { echo $crops_arr[$j]['f10_spend_money_fertiliser']; } ?>" onBlur="getTotalMoneySpend('f10_spend_money', 'f10_spend_money_fertiliser', 'f10_spend_money_pesticide', 'f10_spend_money_labour', 'f10_spend_money_other_expenses', 'f10_spend_money_total',<?php echo $id; ?>);" id="f10_spend_money_fertiliser<?php echo $id; ?>" name="f10_spend_money_fertiliser<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying fertiliser">Rs
	                                                                                    </div>
	                                                                                </div>	<!-- spend money for Fertiliser -->
	                                                                                <!-- =================== -->
                                                                                    <!-- END : FERTILISER -->
                                                                                    <!-- =================== -->
                                                                                    ...
                                                                                    <!-- =================== -->
	                                                                                <div class="control-group span6">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Seeds in KGs <span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_consumption_seeds'])) && $crops_arr[$j]['f10_consumption_seeds'] != '') { echo $crops_arr[$j]['f10_consumption_seeds']; } ?>" id="f10_consumption_seeds<?php echo $id; ?>" name="f10_consumption_seeds<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Seeds in KGs"> KGs
	                                                                                    </div>
	                                                                                </div>	<!-- How much was the total consumption of Seeds in KGs -->
	                                                                                ...
	                                                                                <div class="control-group span6">
	                                                                                    ...
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_spend_money'])) && $crops_arr[$j]['f10_spend_money'] != '') { echo $crops_arr[$j]['f10_spend_money']; } ?>" onBlur="getTotalMoneySpend('f10_spend_money', 'f10_spend_money_fertiliser', 'f10_spend_money_pesticide', 'f10_spend_money_labour', 'f10_spend_money_other_expenses', 'f10_spend_money_total',<?php echo $id; ?>);" id="f10_spend_money<?php echo $id; ?>" name="f10_spend_money<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying seeds">Rs
	                                                                                    </div>
	                                                                                </div>	<!-- spend money for seeds -->
	                                                                                <!-- =================== -->
                                                                                    <!-- END : Seeds -->
                                                                                    <!-- =================== -->
                                                                                    ...
                                                                                    <!-- =================== -->
	                                                                                <div class="control-group span6">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Pesticides in KGs <span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_consumption_pesticides'])) && $crops_arr[$j]['f10_consumption_pesticides'] != '') { echo $crops_arr[$j]['f10_consumption_pesticides']; } ?>" id="f10_consumption_pesticides<?php echo $id; ?>" name="f10_consumption_pesticides<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Pesticides in KGs"> KGs
	                                                                                    </div>
	                                                                                </div>	<!-- How much was the total consumption of Pesticides in KGs -->

	                                                                                <div class="control-group span6">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Pesticide?<span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_spend_money_pesticide'])) && $crops_arr[$j]['f10_spend_money_pesticide'] != '') { echo $crops_arr[$j]['f10_spend_money_pesticide']; } ?>" onBlur="getTotalMoneySpend('f10_spend_money', 'f10_spend_money_fertiliser', 'f10_spend_money_pesticide', 'f10_spend_money_labour', 'f10_spend_money_other_expenses', 'f10_spend_money_total',<?php echo $id; ?>);" id="f10_spend_money_pesticide<?php echo $id; ?>" name="f10_spend_money_pesticide<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying pesticide">Rs
	                                                                                    </div>
	                                                                                </div>	<!-- spend money for Pesticide -->
	                                                                                <!-- =================== -->
                                                                                    <!-- END : Pesticides -->
                                                                                    <!-- =================== -->
                                                                                    ...
                                                                                    <!-- =================== -->
	                                                                                <div class="control-group span6">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Other Inputs in KGs <span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_consumption_other_inputs'])) && $crops_arr[$j]['f10_consumption_other_inputs'] != '') { echo $crops_arr[$j]['f10_consumption_other_inputs']; } ?>" id="f10_consumption_other_inputs<?php echo $id; ?>" name="f10_consumption_other_inputs<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Other Inputs in KGs"> KGs
	                                                                                    </div>
	                                                                                </div>	<!-- How much was the total consumption of Other Inputs in KGs -->

	                                                                                <div class="control-group span6">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Other Expenses?<span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_spend_money_other_expenses'])) && $crops_arr[$j]['f10_spend_money_other_expenses'] != '') { echo $crops_arr[$j]['f10_spend_money_other_expenses']; } ?>" onBlur="getTotalMoneySpend('f10_spend_money', 'f10_spend_money_fertiliser', 'f10_spend_money_pesticide', 'f10_spend_money_labour', 'f10_spend_money_other_expenses', 'f10_spend_money_total',<?php echo $id; ?>);" id="f10_spend_money_other_expenses<?php echo $id; ?>" name="f10_spend_money_other_expenses<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying other expenses">Rs
	                                                                                    </div>
	                                                                                </div>	<!-- spend money for Other Expenses -->
	                                                                                <!-- =================== -->
                                                                                    <!-- END : Other Inputs -->
                                                                                    <!-- =================== -->
                                                                                    
	                                                                                <div class="control-group">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Labour?<span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_spend_money_labour'])) && $crops_arr[$j]['f10_spend_money_labour'] != '') { echo $crops_arr[$j]['f10_spend_money_labour']; } ?>" onBlur="getTotalMoneySpend('f10_spend_money', 'f10_spend_money_fertiliser', 'f10_spend_money_pesticide', 'f10_spend_money_labour', 'f10_spend_money_other_expenses', 'f10_spend_money_total',<?php echo $id; ?>);" id="f10_spend_money_labour<?php echo $id; ?>" name="f10_spend_money_labour<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying labour">Rs
	                                                                                    </div>
	                                                                                </div>	<!-- spend money for Labour -->

	                                                                                

	                                                                                <div class="control-group">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">Total spend money for this Crop<span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input readonly type="text" value="<?php if((isset($crops_arr[$j]['f10_spend_money_total'])) && $crops_arr[$j]['f10_spend_money_total'] != '') { echo $crops_arr[$j]['f10_spend_money_total']; } ?>" id="f10_spend_money_total<?php echo $id; ?>" name="f10_spend_money_total<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="Total spend money for this Crop">Rs
	                                                                                    </div>
	                                                                                </div>	<!-- Total spend money for this Crop -->

	                                                                                <div class="control-group">
	                                                                                    <label for="text" class="control-label" style="margin-top:10px">Total Profit Gained for this crop? <span style="color:#F00">*</span></label>
	                                                                                    <div class="controls">
	                                                                                        <input type="text" value="<?php if((isset($crops_arr[$j]['f10_total_profit_gained'])) && $crops_arr[$j]['f10_total_profit_gained'] != '') { echo $crops_arr[$j]['f10_total_profit_gained']; } ?>" id="f10_total_profit_gained<?php echo $id; ?>" name="f10_total_profit_gained<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="Total Profit Gained for this crop">Rs
	                                                                                    </div>
	                                                                                </div>	<!-- Total Profit Gained for this crop? -->
                                                        ...
                                                        <div class="tab-pane" id="div_prev_crop_cycle">
                                                           	...
                                                           	<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_prev_crop_cycle" name="frm_prev_crop_cycle">
                                                                ...
                                                                <input type="hidden" name="f11_points" id="f11_points" value="<?php if(isset($pt_row['pt_frm11']) && $pt_row['pt_frm11'] != ''){ echo $pt_row['pt_frm11']; }else{ echo '0'; } ?>">
                                                                        ...
                                                                        for($k=0;$k<$no_of_prev_crops;$k++)
																		{
																			...
																			<div id="prevcrop<?php echo $id; ?>" style="padding:5px;border:1px solid #d6d6d6;margin:5px;">
                                                    							...
                                                    							<div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_income'])) && $prev_crops_arr[$k]['f11_income'] != '') { echo $prev_crops_arr[$k]['f11_income']; } ?>" id="f11_income<?php echo $id; ?>" name="f11_income<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" onBlur="getIncomeStore(<?php echo $id; ?>)" maxlength="10" data-rule-required="true" onchange="calTotal_f11()" placeholder="Income Achieved">
                                                                                    </div>
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Fertiliser?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_spend_money_fertiliser'])) && $prev_crops_arr[$k]['f11_spend_money_fertiliser'] != '') { echo $prev_crops_arr[$k]['f11_spend_money_fertiliser']; } ?>" onBlur="getTotalMoneySpend('f11_spend_money', 'f11_spend_money_fertiliser', 'f11_spend_money_pesticide', 'f11_spend_money_labour', 'f11_spend_money_other_expenses', 'f11_spend_money_total',<?php echo $id; ?>);" id="f11_spend_money_fertiliser<?php echo $id; ?>" name="f11_spend_money_fertiliser<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying fertiliser">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Fertiliser -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Seeds in KGs <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_consumption_seeds'])) && $prev_crops_arr[$k]['f11_consumption_seeds'] != '') { echo $prev_crops_arr[$k]['f11_consumption_seeds']; } ?>" id="f11_consumption_seeds<?php echo $id; ?>" name="f11_consumption_seeds<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Seeds in KGs"> KGs
                                                                                    </div>
                                                                                </div>	<!-- How much was the total consumption of Seeds in KGs -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying seeds?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_spend_money'])) && $prev_crops_arr[$k]['f11_spend_money'] != '') { echo $prev_crops_arr[$k]['f11_spend_money']; } ?>" onBlur="getTotalMoneySpend('f11_spend_money', 'f11_spend_money_fertiliser', 'f11_spend_money_pesticide', 'f11_spend_money_labour', 'f11_spend_money_other_expenses', 'f11_spend_money_total',<?php echo $id; ?>);" id="f11_spend_money<?php echo $id; ?>" name="f11_spend_money<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying seeds">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for seeds -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Pesticides in KGs <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_consumption_pesticides'])) && $prev_crops_arr[$k]['f11_consumption_pesticides'] != '') { echo $prev_crops_arr[$k]['f11_consumption_pesticides']; } ?>" id="f11_consumption_pesticides<?php echo $id; ?>" name="f11_consumption_pesticides<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Pesticides in KGs"> KGs
                                                                                    </div>
                                                                                </div>	<!-- How much was the total consumption of Pesticides in KGs -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Pesticide?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_spend_money_pesticide'])) && $prev_crops_arr[$k]['f11_spend_money_pesticide'] != '') { echo $prev_crops_arr[$k]['f11_spend_money_pesticide']; } ?>" onBlur="getTotalMoneySpend('f11_spend_money', 'f11_spend_money_fertiliser', 'f11_spend_money_pesticide', 'f11_spend_money_labour', 'f11_spend_money_other_expenses', 'f11_spend_money_total',<?php echo $id; ?>);" id="f11_spend_money_pesticide<?php echo $id; ?>" name="f11_spend_money_pesticide<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying pesticide">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Pesticide -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Other Inputs in KGs <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_consumption_other_inputs'])) && $prev_crops_arr[$k]['f11_consumption_other_inputs'] != '') { echo $prev_crops_arr[$k]['f11_consumption_other_inputs']; } ?>" id="f11_consumption_other_inputs<?php echo $id; ?>" name="f11_consumption_other_inputs<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Other Inputs in KGs"> KGs
                                                                                    </div>
                                                                                </div>	<!-- How much was the total consumption of Other Inputs in KGs -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Other Expenses?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_spend_money_other_expenses'])) && $prev_crops_arr[$k]['f11_spend_money_other_expenses'] != '') { echo $prev_crops_arr[$k]['f11_spend_money_other_expenses']; } ?>" onBlur="getTotalMoneySpend('f11_spend_money', 'f11_spend_money_fertiliser', 'f11_spend_money_pesticide', 'f11_spend_money_labour', 'f11_spend_money_other_expenses', 'f11_spend_money_total',<?php echo $id; ?>);" id="f11_spend_money_other_expenses<?php echo $id; ?>" name="f11_spend_money_other_expenses<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying other expenses">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Other Expenses -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Labour?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_spend_money_labour'])) && $prev_crops_arr[$k]['f11_spend_money_labour'] != '') { echo $prev_crops_arr[$k]['f11_spend_money_labour']; } ?>" onBlur="getTotalMoneySpend('f11_spend_money', 'f11_spend_money_fertiliser', 'f11_spend_money_pesticide', 'f11_spend_money_labour', 'f11_spend_money_other_expenses', 'f11_spend_money_total',<?php echo $id; ?>);" id="f11_spend_money_labour<?php echo $id; ?>" name="f11_spend_money_labour<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying labour">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Labour -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">Total spend money for this Crop<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input readonly type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_spend_money_total'])) && $prev_crops_arr[$k]['f11_spend_money_total'] != '') { echo $prev_crops_arr[$k]['f11_spend_money_total']; } ?>" id="f11_spend_money_total<?php echo $id; ?>" name="f11_spend_money_total<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="Total spend money for this Crop">Rs
                                                                                    </div>
                                                                                </div>	<!-- Total spend money for this Crop -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">Total Profit Gained for this crop? <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($prev_crops_arr[$k]['f11_total_profit_gained'])) && $prev_crops_arr[$k]['f11_total_profit_gained'] != '') { echo $prev_crops_arr[$k]['f11_total_profit_gained']; } ?>" id="f11_total_profit_gained<?php echo $id; ?>" name="f11_total_profit_gained<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="Total Profit Gained for this crop">Rs
                                                                                    </div>
                                                                                </div>	<!-- Total Profit Gained for this crop? -->
                                                                                ...
                                                                                </div> -->	<!-- Was your crop damaged / destroyed last year -->
																			...
																			<script>
																				...
																				function getIncomeStore(incrementalID)
																				{
																					var f11_income	= parseInt($('#f11_income'+incrementalID).val()) || 0;

																					var hid_f11_income	= parseInt($('hid_f11_income').val()) || 0;

																					if(hid_f11_income != 0)
																					{
																						hid_f11_income += f11_income;
																					}
																					else
																					{
																						hid_f11_income = f11_income;
																					...
																					//alert(hid_f11_income);

																					$('#hid_f11_income').val(hid_f11_income);
																				}
                                                        ...
                                                        <div class="tab-pane" id="div_cur_crop_cycle">
                                                           	...
                                                           	<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_cur_crop_cycle" name="frm_cur_crop_cycle">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f14_points" name="f14_points" value="<?php if(isset($pt_row['pt_frm14']) && $pt_row['pt_frm14'] != ''){ echo $pt_row['pt_frm14']; }else{ echo '0'; } ?>">
                                                                        ...
                                                                        for($l=0;$l<$no_of_cur_crops;$l++)
																		{
                                                                            ...
                                                                            <div id="curcrop<?php echo $id; ?>" style="padding:5px;border:1px solid #d6d6d6;margin:5px;">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select id="f14_cultivating<?php echo $id; ?>" name="f14_cultivating<?php echo $id; ?>" class="select2-me input-xlarge" data-rule-required="true" onchange="get_variety(this.value,<?php echo $id; ?>)">
                                                                                            ...
                                                                                            while($crop = mysqli_fetch_array($crops))
                                                                                            {
	                                                                                            ...
	                                                                                            ?>
	                                                                                            <option value="<?php echo $crop['crop_id']; ?>" point="7" <?php if(isset($crop['crop_id']) && $crop['crop_id'] == $cur_crops_arr[$l]['f14_cultivating']){ ?> selected <?php } ?>>
	                                                                                            	<?php echo ucwords($crop['crop_name']); ?>
	                                                                                            </option>
	                                                                                            <?php
                                                                                            }
                                                                                            ?>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select id="f14_variety<?php echo $id; ?>" name="f14_variety<?php echo $id; ?>" class="select2-me input-xlarge" data-rule-required="true" >
                                                                                            <option value="" disabled selected> Select here</option>
                                                                                            <?php
                                                                                            if(isset($cur_crops_arr[$l]['f14_cultivating']) && $cur_crops_arr[$l]['f14_cultivating']!="")
                                                                                            {
																								$result     = lookup_value('tbl_crop_varieties',array(),array("fk_crop_id"=>$cur_crops_arr[$l]['f14_cultivating']),array(),array(),array());
																								if($result)
																								{
																									while($row = mysqli_fetch_array($result))
																									{
																										...
																										?>
																										<option value="<?php echo $row['variety_id']; ?>" <?php if(isset($row['variety_id']) && $row['variety_id'] == $cur_crops_arr[$l]['f14_variety']){ ?> selected <?php } ?>>
																												<?php echo $row['variety_name'].' '.$row['variety_type']; ?>
																										</option>
																										<?php
																									}
																								}
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <label for="text" class="control-label" style="margin-top:10px">In How many acres did you sow the crops <?php echo $id; ?>? <span style="color:#F00">*</span></label> 
                                                                                    <div class="controls">
                                                                                    	<!-- f14_total_acrage -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Fertilizer in KGs <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_consumption_fertilizer'])) && $cur_crops_arr[$l]['f14_consumption_fertilizer'] != '') { echo $cur_crops_arr[$l]['f14_consumption_fertilizer']; } ?>" id="f14_consumption_fertilizer<?php echo $id; ?>" name="f14_consumption_fertilizer<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Fertilizer in KGs"> KGs
                                                                                    </div>
                                                                                </div>	<!-- How much was the total consumption of Fertilizer in KGs -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Fertiliser?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_spend_money_fertiliser'])) && $cur_crops_arr[$l]['f14_spend_money_fertiliser'] != '') { echo $cur_crops_arr[$l]['f14_spend_money_fertiliser']; } ?>" onBlur="getTotalMoneySpend('f14_spend_money', 'f14_spend_money_fertiliser', 'f14_spend_money_pesticide', 'f14_spend_money_labour', 'f14_spend_money_other_expenses', 'f14_spend_money_total',<?php echo $id; ?>);" id="f14_spend_money_fertiliser<?php echo $id; ?>" name="f14_spend_money_fertiliser<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying fertiliser">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Fertiliser -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Seeds in KGs <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_consumption_seeds'])) && $cur_crops_arr[$l]['f14_consumption_seeds'] != '') { echo $cur_crops_arr[$l]['f14_consumption_seeds']; } ?>" id="f14_consumption_seeds<?php echo $id; ?>" name="f14_consumption_seeds<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Seeds in KGs"> KGs
                                                                                    </div>
                                                                                </div>	<!-- How much was the total consumption of Seeds in KGs -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying seeds?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_spend_money'])) && $cur_crops_arr[$l]['f14_spend_money'] != '') { echo $cur_crops_arr[$l]['f14_spend_money']; } ?>" onBlur="getTotalMoneySpend('f14_spend_money', 'f14_spend_money_fertiliser', 'f14_spend_money_pesticide', 'f14_spend_money_labour', 'f14_spend_money_other_expenses', 'f14_spend_money_total',<?php echo $id; ?>);" id="f14_spend_money<?php echo $id; ?>" name="f14_spend_money<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying seeds">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for seeds -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Pesticides in KGs <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_consumption_pesticides'])) && $cur_crops_arr[$l]['f14_consumption_pesticides'] != '') { echo $cur_crops_arr[$l]['f14_consumption_pesticides']; } ?>" id="f14_consumption_pesticides<?php echo $id; ?>" name="f14_consumption_pesticides<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Pesticides in KGs"> KGs
                                                                                    </div>
                                                                                </div>	<!-- How much was the total consumption of Pesticides in KGs -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Pesticide?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_spend_money_pesticide'])) && $cur_crops_arr[$l]['f14_spend_money_pesticide'] != '') { echo $cur_crops_arr[$l]['f14_spend_money_pesticide']; } ?>" onBlur="getTotalMoneySpend('f14_spend_money', 'f14_spend_money_fertiliser', 'f14_spend_money_pesticide', 'f14_spend_money_labour', 'f14_spend_money_other_expenses', 'f14_spend_money_total',<?php echo $id; ?>);" id="f14_spend_money_pesticide<?php echo $id; ?>" name="f14_spend_money_pesticide<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying pesticide">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Pesticide -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much was the total consumption of Other Inputs in KGs <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_consumption_other_inputs'])) && $cur_crops_arr[$l]['f14_consumption_other_inputs'] != '') { echo $cur_crops_arr[$l]['f14_consumption_other_inputs']; } ?>" id="f14_consumption_other_inputs<?php echo $id; ?>" name="f14_consumption_other_inputs<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="How much was the total consumption of Other Inputs in KGs"> KGs
                                                                                    </div>
                                                                                </div>	<!-- How much was the total consumption of Other Inputs in KGs -->
                                                                                ...
                                                                                <div class="control-group span6">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Other Expenses?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_spend_money_other_expenses'])) && $cur_crops_arr[$l]['f14_spend_money_other_expenses'] != '') { echo $cur_crops_arr[$l]['f14_spend_money_other_expenses']; } ?>" onBlur="getTotalMoneySpend('f14_spend_money', 'f14_spend_money_fertiliser', 'f14_spend_money_pesticide', 'f14_spend_money_labour', 'f14_spend_money_other_expenses', 'f14_spend_money_total',<?php echo $id; ?>);" id="f14_spend_money_other_expenses<?php echo $id; ?>" name="f14_spend_money_other_expenses<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying other expenses">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Other Expenses -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Labour?<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_spend_money_labour'])) && $cur_crops_arr[$l]['f14_spend_money_labour'] != '') { echo $cur_crops_arr[$l]['f14_spend_money_labour']; } ?>" onBlur="getTotalMoneySpend('f14_spend_money', 'f14_spend_money_fertiliser', 'f14_spend_money_pesticide', 'f14_spend_money_labour', 'f14_spend_money_other_expenses', 'f14_spend_money_total',<?php echo $id; ?>);" id="f14_spend_money_labour<?php echo $id; ?>" name="f14_spend_money_labour<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying labour">Rs
                                                                                    </div>
                                                                                </div>	<!-- spend money for Labour -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">Total spend money for this Crop<span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input readonly type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_spend_money_total'])) && $cur_crops_arr[$l]['f14_spend_money_total'] != '') { echo $cur_crops_arr[$l]['f14_spend_money_total']; } ?>" id="f14_spend_money_total<?php echo $id; ?>" name="f14_spend_money_total<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="Total spend money for this Crop">Rs
                                                                                    </div>
                                                                                </div>	<!-- Total spend money for this Crop -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label for="text" class="control-label" style="margin-top:10px">Total Profit Gained for this crop? <span style="color:#F00">*</span></label>
                                                                                    <div class="controls">
                                                                                        <input type="text" value="<?php if((isset($cur_crops_arr[$l]['f14_total_profit_gained'])) && $cur_crops_arr[$l]['f14_total_profit_gained'] != '') { echo $cur_crops_arr[$l]['f14_total_profit_gained']; } ?>" id="f14_total_profit_gained<?php echo $id; ?>" name="f14_total_profit_gained<?php echo $id; ?>" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="Total Profit Gained for this crop">Rs
                                                                                    </div>
                                                                                </div>	<!-- Total Profit Gained for this crop? -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select id="f14_diseases<?php echo $id; ?>" name="f14_diseases<?php echo $id; ?>" class="select2-me input-xlarge" data-rule-required="true">
                                                                                            <option value="" disabled selected> Select here</option>
                                                                                            <option value="Disease" <?php if((isset($cur_crops_arr[$l]['f14_diseases'])) && $cur_crops_arr[$l]['f14_diseases'] == 'Disease') { ?> selected <?php } ?>> Disease</option>
                                                                                            <option value="Pest" <?php if((isset($cur_crops_arr[$l]['f14_diseases'])) && $cur_crops_arr[$l]['f14_diseases'] == 'Pest') { ?> selected <?php } ?>> Pest</option>
                                                                                            <option value="Both" <?php if((isset($cur_crops_arr[$l]['f14_diseases'])) && $cur_crops_arr[$l]['f14_diseases'] == 'Both') { ?> selected <?php } ?>> Both</option>
                                                                                            <option value="None" <?php if((isset($cur_crops_arr[$l]['f14_diseases'])) && $cur_crops_arr[$l]['f14_diseases'] == 'None') { ?> selected <?php } ?>> None</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>	<!-- diseases -->
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                    	<div id="div_f14_water_source_type<?php echo $id; ?>">
                                                                                    		<?php
                                                                                    		// Query For getting the list of Water Source
																							$sql_get_f14_water_source_list	= " SELECT * FROM `tbl_water_source` WHERE `status`='1' AND water_source NOT IN (SELECT DISTINCT(water_source_name) FROM tbl_f14_farmer_water_source WHERE fm_id='".$fm_id."' AND count='".$id."') ";
																							...
																							if($res_get_f14_water_source_list)
																							{
																								...
																								?>
																								<select id="f14_water_source_type<?php echo $id; ?>" name="f14_water_source_type<?php echo $id; ?>[]" multiple="multiple"  onChange="console.log($(this).children(':selected').length)" placeholder="Select Water Source" class="select2-me input-xxlarge">
																						           	<?php
																									if($num_get_f14_water_source_list != 0)
																									{
																										...
																										{
																						            		?>
																						            		<option point="<?php echo $row_get_f14_water_source_list['points']; ?>" value="<?php echo $row_get_f14_water_source_list['water_source']; ?>">
																						            				<?php echo trim(ucwords($row_get_f14_water_source_list['water_source'])); ?>
																						           			</option>
																						                	<?php
																										}
																									}
    																							...
    																							<input value="Add Here" class="btn-success" type="button" onclick="addf14WaterSource(<?php echo $fm_id; ?>, <?php echo $id; ?>);">
																								<?php
																								// Query For getting the Service Provider list for that user
																						        $sql_get_f14_farmer_water_source	= " SELECT * FROM `tbl_f14_farmer_water_source` WHERE `fm_id`='".$fm_id."' AND count='".$id."' ";
																						        ...
																						        <table class="table table-bordered dataTable">
																						        	<thead>
																						        		...
																						        		<th style="text-align:center">
																						        			<div style="text-align:center">
																						        				<input type="button" value="Delete" onclick="multipleWaterSourceDelete_f14(<?php echo $fm_id; ?>, <?php echo $id; ?>);" class="btn-danger"/>
																						        			</div>
																						        		</th>
																						        	</thead>
																						        	<tbody>
																						        		...
																						        		if($num_get_f14_farmer_water_source != 0)
																						        		{
																						        			while($row_get_f14_farmer_water_source = mysqli_fetch_array($res_get_f14_farmer_water_source))
																						        			{
																						        				...
																						        				<tr>
																													<td>
																														<?php echo ++$startOffset_f14; ?>
																													</td>
																													<td>
																														<?php echo ucwords($row_get_f14_farmer_water_source['water_source_name']); ?>
																													</td>
																													<td align="center">
																														<!-- <div class="controls" align="center"> -->
																															<input type="checkbox" value="<?php echo $row_get_f14_farmer_water_source['id'] ?>" id="f14_water_source_<?php echo $row_get_f14_farmer_water_source['id'] ?>" name="f14_water_source_<?php echo $row_get_f14_farmer_water_source['id'] ?>" class="css-checkbox f14_water_source">
																														<!-- </div> -->
																													</td>
																												</tr>
																						        				<?php
                                        ...
                                        <div class="tab-pane" id="assets">
                                            <div class="box box-bordered box-color lightgrey">
                                                <div class="box-content nopadding">
                                                    <div class="tas-container">
                                                        <ul class="tabs tabs-inline tabs-left">
                                                            <li id="li_asset_details" class='active'>
                                                    ...
                                                    <div class="tab-content padding tab-content-inline">
                                                        <div class="tab-pane active" id="div_asset_details">
                                                            ...
                                                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_asset_details" name="frm_asset_details">
                                                                ...
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f12_points" name="f12_points" value="<?php if((isset($data['f12_points'])) && $data['f12_points'] != ''){ echo $data['f12_points']; } ?>"> 
                                                        ...
                                                        <div class="tab-pane" id="div_live_stock">
                                                        	...
                                                        	<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_live_stock" name="frm_live_stock">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f13_points" name="f13_points" value="<?php echo $data['f13_points']; ?>">
                                                                ...
                                                                <div class="form-content">
                                                                    ...
                                                                    <div id="livestock_count" style="display:none">
                                                                        ...
                                                                        <div class="control-group" >
                                                                            ...
                                                                            <div class="controls">
                                                                                <input type="text" value="<?php if((isset($data['f13_livestock_income'])) && $data['f13_livestock_income'] != ''){ echo $data['f13_livestock_income']; } ?>" onKeyUp="getYearlyIncome(this.value);" onBlur="getSumOfLiveStockIncome();" onKeyPress="return numsonly(event);" id="f13_livestock_income" name="f13_livestock_income" class="input-xlarge"  data-rule-required="true" placeholder="Income Gained">in Rs
                                                                            </div>
                                                                        </div>

                                                                        <div class="control-group" >
                                                                            <label for="text" class="control-label" style="margin-top:10px">Income Gained From Livestock [Per Year].</label>
                                                                            <div class="controls">
                                                                                <input readonly type="text" value="<?php if((isset($data['f13_livestock_income_year'])) && $data['f13_livestock_income_year'] != ''){ echo $data['f13_livestock_income_year']; } ?>" onKeyPress="return numsonly(event);" id="f13_livestock_income_year" name="f13_livestock_income_year" class="input-xlarge" data-rule-required="true" placeholder="Income Gained Per Year">in Rs
                                                                            </div>
                                                                        </div>
                                                                    </div>	<!--livestock_count-->
                                                                    ...
                                                                    <script type="text/javascript">
                                                                    	...
                                                                    	function getSumOfLiveStockIncome()
                                                                    	{
                                                                    		
                                                                    		var f13_livestock_income 	= parseInt($('#f13_livestock_income').val()) || 0;
                                                                    		//alert(f13_livestock_income);
                                                                    		var hid_livestock_income	= parseInt($('#hid_livestock_income').val()) || 0;
                                                                    		//alert('1 : '+hid_livestock_income);
                                                                    		hid_livestock_income	= f13_livestock_income;
                                                                    		//alert('3 : '+hid_livestock_income);
                                                                    		
                                                                    		//alert(hid_livestock_income);

                                                                    		$('#hid_livestock_income').val(hid_livestock_income);
                                                                    	}
                                        ...
                                        <div class="tab-pane" id="loan">
                                            <div class="box box-bordered box-color lightgrey">
                                                <div class="box-content nopadding">
                                                    <div class="tas-container">
                                                        <ul class="tabs tabs-inline tabs-left">
                                                            <li id="li_financial_details" class='active'>
                                                    ...
                                                    <div class="tab-content padding tab-content-inline">
                                                        <div class="tab-pane active" id="div_financial_details">
                                                           ...
                                                           <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_financial_details" name="frm_financial_details">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f8_points" name="f8_points" value="<?php if(isset($pt_row['pt_frm8']) && $pt_row['pt_frm8'] != ''){ echo $pt_row['pt_frm8']; } else { echo '0'; } ?>">
                                                                	...
                                                                	<div id="loan_detail" style="padding:5px;border:1px solid #d6d6d6;margin:5px;">
                                                                        ...
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
																				...
																				//echo '<br>';
																				?>
                                                                            	<input type="hidden" name="hid_livestock_income" id="hid_livestock_income" value="<?php echo $livestock_income; ?>">
                                                                				<input type="hidden" name="hid_f11_income" id="hid_f11_income" value="<?php echo $prev_crop_income; ?>">
                                                        ...
                                                        <div class="tab-pane" id="div_financial_history">
                                                           	...
                                                           	<form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_financial_history" name="frm_financial_history">
                                                                ...
                                                                <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $fm_id ?>">
                                                                <input type="hidden" id="fm_caid" name="fm_caid" value="<?php echo $_SESSION['fm_caid']; ?>">
                                                                <input type="hidden" id="f8_financial_history_points" name="f8_financial_history_points" value="<?php if(isset($pt_row['pt_frm8_fh']) && $pt_row['pt_frm8_fh'] != ''){ echo $pt_row['pt_frm8_fh']; } else { echo 0; } ?>">
                                                                ...
                                                                <div class="form-content">
                                                                    ...
                                                                    <!-- <div class="control-group">
								                                   	...
								                                   	<div class="control-group">
                                                                        <label for="text" class="control-label" style="margin-top:10px">Do you have a crop insurance? <span style="color:#F00">*</span></label>
                                                                        <div class="controls">
                                                                            <select id="f8_crop_insurance" name="f8_crop_insurance" class="select2-me input-xlarge" data-rule-required="true">
                                                                                <option value="" selected disabled>Select Here</option>
                                                                                <option <?php if((isset($data['f8_crop_insurance'])) && $data['f8_crop_insurance'] == 'yes'){ ?> selected <?php } ?> value="yes">Yes</option>
                                                                                <option <?php if((isset($data['f8_crop_insurance'])) && $data['f8_crop_insurance'] == 'no'){ ?> selected <?php } ?> value="no">No</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>	<!-- Do you have a crop insurance? -->

                                                                    <div id="div_crop_insurance_display" style="display:none;padding: 5px; border: 1px solid #d6d6d6; margin: 5px;"> 

																		<div class="control-group">
                                                                            <label for="numberfield" class="control-label">What was the amount of the Insurance?</label>
                                                                            <div class="controls">
                                                                                <input  type="text" class="input-xlarge" placeholder="What was the amount of the Insurance?" name="f8_insurance_amount" id="f8_insurance_amount" value="<?php if((isset($data['f8_insurance_amount'])) && $data['f8_insurance_amount'] != ''){ echo $data['f8_insurance_amount']; } ?>" onKeyPress="return numsonly(event);" data-rule-required="true" >
                                                                            </div>
                                                                        </div>	<!-- What was the amount of the Insurance -->

                                                                        <div class="control-group">
                                                                            <label for="numberfield" class="control-label">What was the Name of the insurer?</label>
                                                                            <div class="controls">
                                                                                <input  type="text" class="input-xlarge" placeholder="What was the Name of the insurer?" name="f8_insurer_name" id="f8_insurer_name" value="<?php if((isset($data['f8_insurer_name'])) && $data['f8_insurer_name'] != ''){ echo $data['f8_insurer_name']; } ?>" data-rule-required="true" >
                                                                            </div>
                                                                        </div>	<!-- What was the amount of the Insurance -->
																	...
																	<!-- <div id="div_any_insurance_display" style="display:none;padding: 5px; border: 1px solid #d6d6d6; margin: 5px;"> -->
                                                                        ...
                                                                        <!-- <div class="control-group">
                                                                            ...
                                                                            <div class="controls">
                                                                                <input  type="text" class="input-xlarge" placeholder="What was the name of the Insurance?" name="f8_insurance_name" id="f8_insurance_name" value="<?php //if((isset($data['f8_insurance_name'])) && $data['f8_insurance_name'] != ''){ echo $data['f8_insurance_name']; } ?>" data-rule-required="true" >
                                                                            </div>
                                                                    ...
                                                                    <!-- <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <input type="text" class="input-xlarge" placeholder="What previous loans have you taken?" name="f8_prev_loan_details" id="f8_prev_loan_details" value="<?php //if((isset($data['f8_prev_loan_details'])) && $data['f8_prev_loan_details'] != ''){ echo $data['f8_prev_loan_details']; } ?>" data-rule-required="true" >
                                                                        </div>
                                                                    ...
                                                                    <!-- <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <input  type="text" class="input-xlarge" placeholder="What did you use these loan amount for?" name="f8_use_of_prev_loan_amount" id="f8_use_of_prev_loan_amount" value="<?php //if((isset($data['f8_use_of_prev_loan_amount'])) && $data['f8_use_of_prev_loan_amount'] != ''){ echo $data['f8_use_of_prev_loan_amount']; } ?>" data-rule-required="true" >
                                                                        </div>
			...
			*/
			...
			function appendContent()
			{
				...
				cropData	+= '<div id="crop'+contentCountCrop+'" style="padding:5px;border:1px solid #d6d6d6;margin:5px;display:none;">';
					...
					cropData	+= '<div id="crop_detail" style=" padding: 10px; margin: 5px;">';
                        ...
                        cropData	+= '    <div class="controls">';
                        cropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f10_spend_money\', \'f10_spend_money_fertiliser\', \'f10_spend_money_pesticide\', \'f10_spend_money_labour\', \'f10_spend_money_other_expenses\', \'f10_spend_money_total\','+contentCountCrop+');" id="f10_spend_money'+contentCountCrop+'" name="f10_spend_money'+contentCountCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying seeds">Rs';
                        cropData	+= '    </div>';
                        cropData	+= '</div>';
                        ...
                        cropData	+= '    <div class="controls">';
                        cropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f10_spend_money\', \'f10_spend_money_fertiliser\', \'f10_spend_money_pesticide\', \'f10_spend_money_labour\', \'f10_spend_money_other_expenses\', \'f10_spend_money_total\','+contentCountCrop+');" id="f10_spend_money_fertiliser'+contentCountCrop+'" name="f10_spend_money_fertiliser'+contentCountCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying fertiliser">Rs';
                        cropData	+= '    </div>';
                        cropData	+= '</div>';
                        ...
                        cropData	+= '    <div class="controls">';
                        cropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f10_spend_money\', \'f10_spend_money_fertiliser\', \'f10_spend_money_pesticide\', \'f10_spend_money_labour\', \'f10_spend_money_other_expenses\', \'f10_spend_money_total\','+contentCountCrop+');" id="f10_spend_money_pesticide'+contentCountCrop+'" name="f10_spend_money_pesticide'+contentCountCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying pesticide">Rs';
                        cropData	+= '    </div>';
                        cropData	+= '</div>';
                        ...
                        cropData	+= '    <div class="controls">';
                        cropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f10_spend_money\', \'f10_spend_money_fertiliser\', \'f10_spend_money_pesticide\', \'f10_spend_money_labour\', \'f10_spend_money_other_expenses\', \'f10_spend_money_total\','+contentCountCrop+');" id="f10_spend_money_labour'+contentCountCrop+'" name="f10_spend_money_labour'+contentCountCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying labour">Rs';
                        cropData	+= '    </div>';
                        cropData	+= '</div>';

                        cropData	+= '<div class="control-group">';
                        cropData	+= '    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Other Expenses?<span style="color:#F00">*</span></label>';
                        cropData	+= '    <div class="controls">';
                        cropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f10_spend_money\', \'f10_spend_money_fertiliser\', \'f10_spend_money_pesticide\', \'f10_spend_money_labour\', \'f10_spend_money_other_expenses\', \'f10_spend_money_total\','+contentCountCrop+');" id="f10_spend_money_other_expenses'+contentCountCrop+'" name="f10_spend_money_other_expenses'+contentCountCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying other expenses">Rs';
                        cropData	+= '    </div>';
                        cropData	+= '</div>';
			...
			function appendPrevCropContent()
			{
				...
				prevCropData	+= '<div id="prevcrop'+contentCountPrevCrop+'" style="padding:5px;border:1px solid #d6d6d6;margin:5px; display:none;">';
                    ...
                    prevCropData	+= '    <div class="controls">';
                    prevCropData	+= '        <input type="text"  onBlur="getTotalMoneySpend(\'f11_spend_money\', \'f11_spend_money_fertiliser\', \'f11_spend_money_pesticide\', \'f11_spend_money_labour\', \'f11_spend_money_other_expenses\', \'f11_spend_money_total\','+contentCountPrevCrop+');" id="f11_spend_money'+contentCountPrevCrop+'" name="f11_spend_money'+contentCountPrevCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying seeds">Rs';
                    prevCropData	+= '    </div>';
                    prevCropData	+= '</div>';
                    ...
                    prevCropData	+= '    <div class="controls">';
                    prevCropData	+= '        <input type="text"  onBlur="getTotalMoneySpend(\'f11_spend_money\', \'f11_spend_money_fertiliser\', \'f11_spend_money_pesticide\', \'f11_spend_money_labour\', \'f11_spend_money_other_expenses\', \'f11_spend_money_total\','+contentCountPrevCrop+');" id="f11_spend_money_fertiliser'+contentCountPrevCrop+'" name="f11_spend_money_fertiliser'+contentCountPrevCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying fertiliser">Rs';
                    prevCropData	+= '    </div>';
                    prevCropData	+= '</div>';
                    ...
                    prevCropData	+= '    <div class="controls">';
                    prevCropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f11_spend_money\', \'f11_spend_money_fertiliser\', \'f11_spend_money_pesticide\', \'f11_spend_money_labour\', \'f11_spend_money_other_expenses\', \'f11_spend_money_total\','+contentCountPrevCrop+');" id="f11_spend_money_pesticide'+contentCountPrevCrop+'" name="f11_spend_money_pesticide'+contentCountPrevCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying pesticide">Rs';
                    prevCropData	+= '    </div>';
                    prevCropData	+= '</div>';
                    ...
                    prevCropData	+= '    <div class="controls">';
                    prevCropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f11_spend_money\', \'f11_spend_money_fertiliser\', \'f11_spend_money_pesticide\', \'f11_spend_money_labour\', \'f11_spend_money_other_expenses\', \'f11_spend_money_total\','+contentCountPrevCrop+');" id="f11_spend_money_labour'+contentCountPrevCrop+'" name="f11_spend_money_labour'+contentCountPrevCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying labour">Rs';
                    prevCropData	+= '    </div>';
                    prevCropData	+= '</div>';

                    prevCropData	+= '<div class="control-group">';
                    prevCropData	+= '    <label for="text" class="control-label" style="margin-top:10px">How much money you spend in buying Other Expenses?<span style="color:#F00">*</span></label>';
                    prevCropData	+= '    <div class="controls">';
                    prevCropData	+= '        <input type="text" onBlur="getTotalMoneySpend(\'f11_spend_money\', \'f11_spend_money_fertiliser\', \'f11_spend_money_pesticide\', \'f11_spend_money_labour\', \'f11_spend_money_other_expenses\', \'f11_spend_money_total\','+contentCountPrevCrop+');" id="f11_spend_money_other_expenses'+contentCountPrevCrop+'" name="f11_spend_money_other_expenses'+contentCountPrevCrop+'" class="input-xlarge" onKeyPress="return numsonly(event);" maxlength="10" data-rule-required="true" placeholder="money you spend in buying other expenses">Rs';
                    prevCropData	+= '    </div>';
                    prevCropData	+= '</div>';
					...
					// 	prevCropData	+= '<div class="controls">';
					// 		prevCropData	+= '<select id="f11_damaged_prev_crop'+contentCountPrevCrop+'" name="f11_damaged_prev_crop'+contentCountPrevCrop+'" class="input-xlarge" data-rule-required="true" onchange="calTotal_f11();divDisplayOpen(this.value, \'div_damaged_prev_crop_display'+contentCountPrevCrop+'\');">';
					// 			prevCropData	+= '<option value="" disabled selected> Select here</option>';
					// 			prevCropData	+= '<option point="0" value="yes"> Yes</option>';
					// 			prevCropData	+= '<option point="10" value="no"> No</option>';
					// 		prevCropData	+= '</select>';
					...
					// prevCropData	+= '<div id="div_damaged_prev_crop_display'+contentCountPrevCrop+'" style="display:none;padding: 5px; border: 1px solid #d6d6d6; margin: 5px;">';
					// 	prevCropData	+= '<div class="control-group">';
			...
			function getTotalMoneySpend(txt_id_1, txt_id_2, txt_id_3, txt_id_4, txt_id_5, txt_total_val, incrementalID)
			{
