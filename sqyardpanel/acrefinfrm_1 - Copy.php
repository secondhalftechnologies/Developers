								...
								<form enctype="multipart/form-data" method="POST" class='form-horizontal form-wizard wizard-vertical' id="frm_knowledge_detail">
										...
										<div class="form-content">
                                             ...
                                             <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      <input type="text" id="f1_mfname" name="f1_mfname" class="input-xxlarge v_name" data-rule-minlength="3" data-rule-maxlength="50" placeholder="First Name">
                                                      </div>
                                              </div><!--Mother First name-->
                                             <div class="control-group">
                                                      <label for="text" class="control-label" style="margin-top:10px">Mother's Middle Name</label>
                                                      <div class="controls">
                                                      <input type="text" id="f1_mmname" name="f1_mmname" class="input-xxlarge v_name" data-rule-minlength="3" data-rule-maxlength="50" placeholder="Middle Name">
                                                      </div>
											 ...
											 <div class="control-group">
                                                      <label for="text" class="control-label " style="margin-top:10px">Date of Birth<span style="color:#F00">*</span></label>
                                                      <div class="controls">
                                                      	<input type="text" id="f1_dob" name="f1_dob" class="datepicker" data-rule-required="true" placeholder="Date of Birth">
                                                      </div>
                                              </div><!--Dob-->

                                             <div class="control-group">
                                                      <label for="text" class="control-label" style="margin-top:10px">Farmer's Age (in years)<span style="color:#F00">*</span></label>
                                                      <div class="controls">
                                             ...
                                             <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Alternate No." name="f1_altno" id="f1_altno" class="v_number" data-rule-number="true"  data-rule-minlength="10"  data-rule-maxlength="10" >
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                	<select id="any_other_select" class="input-xxlarge">
                                            ...
                                            <div id="any_other" style="display: none;">
	                                             <div class="control-group">
	                                                        ...
	                                                        <div class="controls">
	                                                            <input type="text"  name="f1_ppno" id="f1_ppno" class="v_text"  data-rule-minlength="6"  data-rule-maxlength="12" placeholder="Passport No">
	                             							</div>
	                                             </div> <!--Passport no-->
	                                             ...
	                                             <div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text"  name="f1_pancard" id="f1_pancard" class="v_text" data-rule-minlength="6"  data-rule-maxlength="10" placeholder="Pan Card">
	                         							</div>
	                                             </div> <!--pan card -->
	                                             ...
	                                             <div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text"  name="f1_vote" id="f1_vote" class="v_text"  data-rule-minlength="6"  data-rule-maxlength="12" placeholder="Voting No">
	                             						</div>
	                                             </div> <!--Voting card no-->
	                                             ...
	                                             <div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text"  name="f1_licno" id="f1_licno" class="v_text"   data-rule-minlength="6"  data-rule-maxlength="12" placeholder="Driving Licence No.">
	                             						</div>
	                                             ...
	                                             <div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text"  name="f1_otherno" class="v_text" id="f1_otherno" data-rule-maxlength="20" placeholder="Any Other No. ">
	                         							</div>
	                                             </div> <!--other-->     
	                                        </div>
                                             ...
                                             <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Experience" name="f1_expfarm" id="f1_expfarm" class="v_number" data-rule-number="true" data-rule-required="true" onChange="calTotal();"   data-rule-maxlength="2">
                             						</div>
