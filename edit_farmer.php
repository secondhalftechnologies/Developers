    ...
    <body class="<?php echo $theme_name; ?>" data-theme="<?php echo $theme_name; ?>">
                            ...
                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_edit_farmer" name="frm_edit_farmer">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="f1_any_other_occupation" name="f1_any_other_occupation" class="select2-me input-xlarge" onChange="getDisplayDiv(this.value, 'div_any_other_occupation_display')">
                                            ...
                                            <option value="yes" <?php if($row_get_farmer_personal_info['f1_any_other_occupation'] == 'yes'){ ?> selected <?php } ?>>Yes</option>
                                            <option value="no" <?php if($row_get_farmer_personal_info['f1_any_other_occupation'] == 'no'){ ?> selected <?php } ?>>No</option>
                                        </select>
                                    </div>
                                ...
                                <div id="div_any_other_occupation_display" style="display:none;">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="<?php if((isset($row_get_farmer_personal_info['f1_occupation_amt'])) && $row_get_farmer_personal_info['f1_occupation_amt'] != '') { echo $row_get_farmer_personal_info['f1_occupation_amt']; } ?>" placeholder="mention the amount earned annually" onKeyPress="return numsonly(event);" name="f1_occupation_amt" id="f1_occupation_amt" class="v_number input-xlarge" data-rule-required="true" data-rule-maxlength="12">
                                        </div>
    	...
    	<script language="javascript">
			...
			$(document).ready(function(){
                ...
                if($('#f1_any_other_occupation').val() == 'yes')
                {
                  $('#div_any_other_occupation_display').show('swing');
                }
                else
                {
                    $('#div_any_other_occupation_display').hide('swing');
                    $('#div_any_other_occupation_display').find('input, select').val('').trigger('change');
                }
