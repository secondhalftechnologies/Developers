                                                       ...
                                                       <label id="comp_2" style="color:#FF0000;width:200px;margin-left:100px;"></label>    
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <input type="radio"  name="loan_want" id="loan_want"  autocomplete="off" data-rule-required="true" value="yes" onClick="show_loan(1)"> Yes
                                                                  &nbsp;&nbsp;<input type="radio"  name="loan_want" id="loan_want"  autocomplete="off" data-rule-required="true" value="no" onClick="show_loan(0)"> No
