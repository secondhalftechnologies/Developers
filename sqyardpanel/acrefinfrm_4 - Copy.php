									...
									<div class="step" id="Step1">
										...
										<div class="form-content">
                                        	...
                                        	<div class="control-group">
												...
												<div class="controls">
													<select id="f4_edudetail" name="f4_edudetail" class="input-xxlarge" data-rule-required="true" onchange="calTotal()">
                                            ...
                                            <div class="control-group">
												...
												<div class="controls">
													<select id="f4_proficiency" name="f4_proficiency" class="input-xxlarge" onchange="calTotal()">
														<option value="" disabled selected> Select here</option>
                                            ...
                                            <div class="control-group">
												...
												<div class="controls">
													<select id="f4_participation" name="f4_participation" class="input-xxlarge" onchange="calTotal()">
														<option value="" disabled selected> Select here</option>
                                            ...
                                            <div id="program_detail" style="display: none; background-color: rgba(0,0,0,0.02); padding: 10px; box-shadow: 1px 1px 2px gray; margin: 20px;">

                                                <div class="control-group">
													<label for="text" class="control-label" style="margin-top:10px">Type of the training Programs<span style="color:#F00">*</span></label>
													<div class="controls">
														<select id="f4_progtype" name="f4_progtype" class="input-xxlarge" data-rule-required="true">
                                                      		<option value="" disabled selected> Select here</option>
	                                        	...
	                                        	<div class="control-group">
													...
													<div class="controls">
														<input type="text" id="f4_progname" name="f4_progname" class="input-xxlarge v_name" data-rule-required="true" data-rule-minlength="4" data-rule-maxlength="100" placeholder="Training Program">
													</div>
												</div>
                                                ...
                                                <div class="control-group">
													...
													<div class="controls">
														<input type="text" id="f4_dateprog" name="f4_dateprog" class="datepicker" placeholder="Date of the program" data-rule-required="true">
													</div>
												</div>
		                                        <!-- Date of the program -->
		                                        ...
		                                        <div class="control-group">
													...
													<div class="controls">
														<input type="text" id="f4_duration" name="f4_duration" class="input-xxlarge v_number" data-rule-number="true"  data-rule-maxlength="3" placeholder="Duration of the program(in days)" data-rule-required="true">
													</div>
												</div>
                                                ...
                                                <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      	<input type="text" id="f4_conducted" name="f4_conducted" class="input-xxlarge v_name" data-rule-minlength="4" data-rule-maxlength="100" data-rule-required="true" placeholder="Who Conducted">
                                                      </div>
                                                ...
                                                <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      	<input type="text" id="f4_crop" name="f4_crop" class="input-xxlarge v_name" data-rule-minlength="4" data-rule-maxlength="100" placeholder="Crop" data-rule-required="true">
                                                      </div>
