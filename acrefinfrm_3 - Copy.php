		...
		<div class="container-fluid">
			...
			<div class="user">
				...
				<div class="dropdown asdf">
					<a href="#" class='dropdown-toggle' data-toggle="dropdown"><?php echo $_SESSION['acrefin_user']; ?> <img src="img/demo/user-avatar.jpg" alt=""></a>
									...
									<div class="step" id="Step1">
										...
										<div class="form-content">
											<div class="control-group">
												...
												<div class="controls">
													<select id="f3_married" name="f3_married" class="input-xxlarge" data-rule-required="true">
                                            ...
                                            <div id="spouse_detail" style="display: none; background-color: rgba(0,0,0,0.02); padding: 10px; box-shadow: 1px 1px 2px gray; margin: 20px;">
                                            	<h2>Spouse Details</h2>
                                            	<div class="control-group">
													<label for="text" class="control-label" style="margin-top:10px">First Name <span style="color:#F00">*</span></label>
													<div class="controls">
														<input type="text" id="f3_spouse_fname" name="f3_spouse_fname" class="input-xxlarge v_name" data-rule-minlength="3" data-rule-maxlength="50" data-rule-required="true" placeholder="First Name">
													</div>
												</div><!--first name-->
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" id="f3_spouse_mname" name="f3_spouse_mname" class="input-xxlarge v_name" data-rule-minlength="3" data-rule-maxlength="50" data-rule-required="true"  placeholder="Middle Name">
													</div>
												</div><!--Middle name-->
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" id="f3_spouse_sname" name="f3_spouse_sname" class="input-xxlarge v_name" data-rule-minlength="3" data-rule-maxlength="50" data-rule-required="true" placeholder="Surname ">
													</div>
												</div><!--surname-->
												...
												<div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                    	<input type="text" id="f3_spouse_age" name="f3_spouse_age" class="v_number" data-rule-number="true" data-rule-minlength="2" data-rule-maxlength="2" data-rule-required="true" placeholder="Age">
                                                    </div>
                                              	</div><!--age-->
                                              	...
                                              	<div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Mobile no." name="f3_spouse_mobno" id="f3_spouse_mobno" class="v_number" data-rule-number="true"  data-rule-minlength="10"  data-rule-maxlength="10" data-rule-required="true" >
                                                        <label id="comp_4" style="color:#FF0000;width:200px;margin-left:100px;"></label>    
                                                    </div>
                                            	</div><!--Mobile no-->
                                            	...
                                            	<div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Aadhaar no." name="f3_spouse_adhno" id="f3_spouse_adhno" class="v_number" data-rule-number="true"  data-rule-minlength="12"  data-rule-maxlength="12" data-rule-required="true">
                         							</div>
                                            	</div> <!--aadhar no-->
                                            	...
                                            	<div class="control-group">
													...
													<div class="controls">
														<select id="f3_spouse_shg" name="f3_spouse_shg" class="input-xxlarge" data-rule-required="true">
															<option value="" disabled selected> Select here</option>
															<option value="yes" point="10"> Yes</option>
	                                            ...
	                                            <div class="control-group" id="shg_name" style="display: none">
													...
													<div class="controls">
														<input type="text" id="f3_spouse_shgname" name="f3_spouse_shgname" class="input-xxlarge v_name" data-rule-required="true" placeholder="Name of SHG">
													</div>
												</div><!--shgname-->
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="f3_spouse_occp" name="f3_spouse_occp" class="input-xxlarge" data-rule-required="true">
															<option value="" disabled selected> Select here</option>
	                                            ...
	                                            <div class="control-group" id="input_income" style="display: none;">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" placeholder="Spouse Income per month" name="f3_spouse_income" id="f3_spouse_income" data-rule-number="true"  data-rule-maxlength="10" data-rule-required="true">
                                                        <label id="comp_4" style="color:#FF0000;width:200px;margin-left:100px;"></label>    
                                                    </div>
                                            	</div><!--income-->
                                            	...
                                            	<div class="control-group">
													...
													<div class="controls">
														<select id="f3_spouse_mfi" name="f3_spouse_mfi" class="input-xxlarge" data-rule-required="true">
															<option value="" disabled selected> Select here</option>
	                                            ...
	                                            <div id="microfinance" style="display: none;background-color: rgba(0,0,0,0.02); padding: 10px; box-shadow: 1px 1px 2px gray; margin: 20px;">
	                                            	...
	                                            	<div class="control-group">
														...
														<div class="controls">
															<select id="f3_spouse_purpose" name="f3_spouse_purpose" class="input-xxlarge" data-rule-required="true">
																<option value="" disabled selected> Select here</option>
		                                            ...
		                                            <div class="control-group">
														...
														<div class="controls">
															<input type="text" id="f3_spouse_mfiname" name="f3_spouse_mfiname" class="input-xxlarge v_name" data-rule-required="true" data-rule-minlength="4"  data-rule-maxlength="100" placeholder="Micro finance firm">
														</div>
													...
													<div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text" placeholder="Amount Taken" name="f3_spouse_mfiamount" id="f3_spouse_mfiamount" class="v_number" data-rule-number="true" data-rule-required="true"  data-rule-maxlength="8">
	                                                    </div>
	                                            	</div><!--mfiamount-->
		                                            ...
		                                            <div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text" placeholder="Rate Of Interest" name="f3_spouse_mfirate" id="f3_spouse_mfirate" class="v_number" data-rule-number="true" data-rule-required="true" data-rule-maxlength="8">
	                                                    </div>
	                                            	...
	                                            	<div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text" placeholder="Loan Tenure" name="f3_spouse_mfitenure" id="f3_spouse_mfitenure" class="v_number" data-rule-number="true" data-rule-required="true"  data-rule-maxlength="3">
	                                                    </div>
	                                            	...
	                                            	<div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text" placeholder="Loan Amount in rupees" name="f3_spouse_mfitotalamount" id="f3_spouse_mfitotalamount" class="v_number" data-rule-number="true" data-rule-required="true"  readonly>
	                                                    </div>
	                                            	...
	                                            	<div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text" placeholder="Total Interests" name="f3_spouse_mfiinterest" id="f3_spouse_mfiinterest" class="v_number" data-rule-number="true" data-rule-required="true"  readonly>
	                                                    </div>
	                                            	</div><!--Total Interest-->
	                                            	...
	                                            	<div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text" placeholder="EMI Paid" name="f3_spouse_mfiemipaid" id="f3_spouse_mfiemipaid" class="v_number" data-rule-number="true" data-rule-required="true"  data-rule-maxlength="3" >
	                                                    </div>
	                                            	</div><!--No. Of EMI Paid-->
	                                            	...
	                                            	<div class="control-group">
	                                                    ...
	                                                    <div class="controls">
	                                                        <input type="text" placeholder="Outstanding Loan Amount With Interest" name="f3_spouse_mfioutstanding" id="f3_spouse_mfioutstanding" class="v_number" data-rule-number="true" data-rule-required="true" readonly>
	                                                    </div>
