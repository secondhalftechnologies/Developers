	...
	if($data['fm_id']!="" &&  $data['fm_caid'] !="")
	{
		...
		if(!$checkExist)
		{
			...
			for($i=1;$i<=$no_of_cur_crop_forecast;$i++)
			{
				...
				$data['f14_spend_money_fertiliser']     = mysqli_real_escape_string($db_con,$_POST['f14_spend_money_fertiliser'.$i]);
				$data['f14_spend_money_pesticide']      = mysqli_real_escape_string($db_con,$_POST['f14_spend_money_pesticide'.$i]);
				$data['f14_spend_money_labour']         = mysqli_real_escape_string($db_con,$_POST['f14_spend_money_labour'.$i]);
				$data['f14_spend_money_other_expenses'] = mysqli_real_escape_string($db_con,$_POST['f14_spend_money_other_expenses'.$i]);
				$data['f14_spend_money_total']          = mysqli_real_escape_string($db_con,$_POST['f14_spend_money_total'.$i]);
				
				$data['f14_total_profit_gained']        = mysqli_real_escape_string($db_con,$_POST['f14_total_profit_gained'.$i]);
				
				$data['f14_consumption_seeds']          = mysqli_real_escape_string($db_con,$_POST['f14_consumption_seeds'.$i]);
				$data['f14_consumption_pesticides']     = mysqli_real_escape_string($db_con,$_POST['f14_consumption_pesticides'.$i]);
				$data['f14_consumption_other_inputs']   = mysqli_real_escape_string($db_con,$_POST['f14_consumption_other_inputs'.$i]);
				$data['f14_consumption_fertilizer']     = mysqli_real_escape_string($db_con,$_POST['f14_consumption_fertilizer'.$i]);
