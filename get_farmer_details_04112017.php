    ...
    <body class="<?php echo $theme_name; ?>" data-theme="<?php echo $theme_name; ?>">
                                                                    ...
                                                                    <div class="form-content">
                                                                        ...
                                                                        <div id="spouse_detail" style="padding:5px;border:1px solid #d6d6d6;margin:5px;">
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <div class="controls">
                                                                                    <input type="text" value="<?php if((isset($data['f3_spouse_age'])) && $data['f3_spouse_age'] != '') { echo $data['f3_spouse_age']; } ?>" id="f3_spouse_age" name="f3_spouse_age" class="v_number input-xlarge" data-rule-number="true" data-rule-maxlength="3" maxlength="3" onKeyPress="return numsonly(event);" data-rule-required="true" placeholder="Age">
                                                                                </div>
                                                                            </div>	<!--age-->
        ...
        <script type="text/javascript">
			...
			function calTotal_f11()
			{
				...
				prev_crop_cycle_g_total = achieved + income + f11_damaged_prev_crop; //+ fertilizers diseases + 
